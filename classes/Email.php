...
class Email {
    ...
    public function enviarConfirmacion() {
         ...
         $mail->setFrom('conferentix@gmail.com');
         ...
         $contenido = '<html>';
         $contenido .= "<p><strong>Hola " . $this->nombre .  "</strong> Has Registrado Correctamente tu cuenta en Conferentix; pero es necesario confirmarla</p>";
