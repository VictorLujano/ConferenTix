...
<section class="resumen">
    <div class="resumen__grid">
        <div <?php aos_animacion(); ?> class="resumen__bloque">
            ...
            <p class="resumen__texto">Presentadores</p>
        </div>
...
<section class="speakers">
    <h2 class="speakers__heading">Presentadores</h2>
    <p class="speakers__descripcion">Conoce a nuestros expertos de ConferenTix</p>
    ...
    <?php foreach($ponentes as $ponente) { ?>
        ...
        <picture>
                ...
                <img class="speaker__imagen" loading="lazy" width="200" height="300" src="img/speakers/<?php echo $evento->ponente->imagen; ?>.png" alt="Imagen Presentador">
            </picture>
...
<section class="boletos">
    <h2 class="boletos__headng">Boletos y precios</h2>
    <p class="boletos__descripcion">Precios para Conferentix</p>

    <div class="boletos__grid">
        <div class="boleto boleto--presencial">
            <h4 class="boleto__logo">&#60;ConferenTix /></h4>
            <p class="boleto__plan">Presencial</p>
            <p class="boleto__precio">$799</p>
        </div>

        <div class="boleto boleto--virtual">
            <h4 class="boleto__logo">&#60;ConferenTix /></h4>
            <p class="boleto__plan">Virtual</p>
            <p class="boleto__precio">$149</p>
        </div>
