    ...
    <div class="evento__informacion">
        ...
        <div class="evento__autor-info">
            <picture>
                ...
                <img class="evento__imagen-autor" loading="lazy" width="200" height="300" src="<?php echo $_ENV['HOST']; ?>/img/speakers/<?php echo $evento->ponente->imagen; ?>.png" alt="Imagen Presentador">
            </picture>
