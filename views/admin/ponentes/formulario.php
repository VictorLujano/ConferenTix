<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input
            ...
            id="apellido"
            name="apellido"
            placeholder="Apellido del presentador"
    ...
    <div class="formulario__campo">
        ...
        <input
            ...
            id="ciudad"
            name="ciudad"
            placeholder="Ciudad del presentador"
    ...
    <div class="formulario__campo">
        ...
        <input
            ...
            id="pais"
            name="pais"
            placeholder="Pais del presentador"
    ...
    <div class="formulario__imagen">
        <picture>
            ...
            <img src="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen;?>.png" alt="Imagen Presentador" >
        </picture>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input
            ...
            class="formulario__input"
            id="tags_input"
            placeholder="Ej. Node.js, PHP, SCSS, Python, Java"
        >
